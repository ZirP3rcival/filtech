...
if($mde=='U3') {
	$id=$_REQUEST['id']; 
	$csql = mysqli_query($con,"SELECT * FROM ft2_asmt_identification WHERE id='$id'"); 
...
<div class="row" style="margin-left: 10px; margin-right: 10px;">
	...
	<textarea class="form-control col-xs-12 col-md-12" id="nqst" name="nqst" rows="6" style="color:#000;" required placeholder="Input Identufucation Question Here"><?=$qst;?></textarea>
    </div> 
<div class="clearfix"></div>
	...
	<textarea required class="form-control col-xs-12 col-md-9" style="width:100%; float:right; color: #000;" id="nqky" name="nqky" rows="3"><?=$qky;?></textarea>
	</div>
<div class="clearfix"></div>
</div>                                                
</form>
