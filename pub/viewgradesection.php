...
<div class="col-xs-6 col-md-7" style="padding-bottom: 0px;">
...
<?php 
$dsql = mysqli_query($con,"SELECT ft2_section_data.*, ft2_grade_data.* FROM ft2_grade_data INNER JOIN ft2_section_data ON ft2_section_data.grd = ft2_grade_data.id WHERE ft2_grade_data.id = '$id'");
